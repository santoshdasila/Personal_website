...
// It will be sent to your email immediately.
// REPLACE THIS STRING WITH YOUR NEW KEY
...
export const TRANSLATIONS: TranslationDictionary = {
  ...
  ES: {
    nav: {
      ...
      SOUND: 'Sonido', TRAVEL: 'Viajes', SIMULATION: 'Simulación', RESOURCES: 'Recursos', CONTACT: 'Contacto'
    },
    headings: {
